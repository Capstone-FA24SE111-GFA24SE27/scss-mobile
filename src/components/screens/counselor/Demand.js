        ...
        {!loading && (
          ...
          >
            ...
            >
              ...
              >
                {demands?.data?.length != 0 ? currentPage : 0} /{" "}
                {demands.totalPages}
              </Text>
            </View>
            <TouchableOpacity
              style={{
                ...
                borderWidth: 1.5,
                borderColor:
                  demands.totalPages == 0 || currentPage >= demands.totalPages
                    ? "#ccc"
                    : "#F39300",
                opacity:
                  demands.totalPages == 0 || currentPage >= demands.totalPages
            ...
            <TouchableOpacity
              ...
              onPress={() => setCurrentPage(demands.totalPages)}
              disabled={
                demands.totalPages == 0 || currentPage >= demands.totalPages
              }
            >
                    ...
                    >
                      ...
                      >
                        {selectedDemand.summarizeNote !== "" ? (
                          ...
                          <Text style={{ fontStyle: "italic", color: "gray", opacity: 0.7 }}>
